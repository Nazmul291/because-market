...
HowItWorksTrial.propTypes = {
  deliveryRange: PropTypes.string,
}

function HowItWorksTrial({ deliveryRange = "" }) {
  return (
    <HowItWorks>
      ...
      <HowUl>
        <HowUlLi>
          ...
          <StepInfo>
            ...
            <StepInfoText>
              Your free starter pack will arrive in the mail.
            </StepInfoText>
          </StepInfo>
        </HowUlLi>
        <HowUlLi>
          ...
          <StepInfo>
            ...
            <StepInfoText>
              ...
              absorbency? <b>Just give us a call at</b> (855) 318-5318 or email
              us at{" "}
              <StepLink
                className="s-link"
                rel="nofollow"
        ...
        <HowUlLi>
          ...
          <StepInfo>
            ...
            <StepInfoText>
              ...
              worry about running out. Your first full order is set for{" "}
              {deliveryRange}.
            </StepInfoText>
          </StepInfo>
        </HowUlLi>
...
export default memo(HowItWorksTrial)
